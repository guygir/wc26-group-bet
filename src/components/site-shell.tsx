    ...
    <div className="relative min-h-screen overflow-x-hidden bg-[radial-gradient(circle_at_top_left,#bbf7d0,transparent_34%),linear-gradient(135deg,#f8fafc,#ecfdf5)] text-slate-950">
      <div className="pointer-events-none fixed inset-0 overflow-hidden" aria-hidden="true">
        ...
        <Image
          ...
          width={1024}
          height={1024}
          className="absolute left-3 top-24 w-32 opacity-[0.36] sm:left-8 sm:top-24 sm:w-44 lg:left-10 lg:w-56"
        />
        <Image
          ...
          width={240}
          height={240}
          className="absolute right-[-0.75rem] top-20 w-36 opacity-[0.32] sm:right-3 sm:top-24 sm:w-48 lg:right-4 lg:w-60"
        />
      </div>
